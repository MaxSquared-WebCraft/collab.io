...
export class RoomService {
  ...
  public getRoomByName(roomName: string): void {
    this.http
      ...
      .subscribe(this.setRoomAndNavigate,(error) => console.log('could find room', error));
  }

  public createRoom(roomName: string): void {
    this.http
      .post<Room>('/room', { name: roomName })
      .subscribe(this.setRoomAndNavigate, (error) => console.log('error creating room', error));
  }
